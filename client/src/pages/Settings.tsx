...
import { Save, User, Bell, Shield, Database, Mail, Globe, Palette } from 'lucide-react';

const Settings: React.FC = () => {
  const [activeTab, setActiveTab] = useState('general');
  const [settings, setSettings] = useState({
    general: {
      siteName: 'WAVIATORLMS',
      siteDescription: 'Wallet Dashboard Management System',
    ...
    email: {
      ...
      smtpUsername: '',
      smtpPassword: '',
      fromEmail: 'noreply@waviatorlms.com',
      fromName: 'WAVIATORLMS'
    }
  });
      ...
      case 'database':
        return (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">Database settings coming soon...</p>
          </div>
        );
      default:
        return null;
